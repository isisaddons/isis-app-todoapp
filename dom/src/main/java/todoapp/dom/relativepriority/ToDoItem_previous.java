...
@Mixin
public class ToDoItem_previous {

    private final ToDoItem toDoItem;
    public ToDoItem_previous(final ToDoItem toDoItem) {
    ...
    public ToDoItem $$() {
        ...
        return relativePriorityService.itemWithPriorityElse(priorityOfPrevious, toDoItem);
    }
