...
public class ApacheIsisPersistableMixinsRoleAndPermissions extends AbstractRoleAndPermissionsFixtureScript {

    public static final String ROLE_NAME = "persistable-mixins-user";

    public ApacheIsisPersistableMixinsRoleAndPermissions() {
